import { type SvgIconProperties, SvgIcons } from './svg-icon'

export function SelectMenuArrowIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 16 11" {...properties}>
...
export function CheckIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 14 14" {...properties}>
      <path
...
export function CheckMarkIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons
      viewBox="0 0 18 18"
      fillRule="evenodd"
...
export function CrossMarkIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons
      viewBox="0 0 18 18"
      fillRule="evenodd"
...
export function EmailIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 17 14" {...properties}>
...
export function TwitterIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 20 16" {...properties}>
...
export function MetamaskIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 397 355" fill="none" {...properties}>
      <g fill="#cdbdb2">
...
export function WalletConnectIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 512 512" fill="none" {...properties}>
      <defs>
...
export function EthereumIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 1920 1920" fill="none" {...properties}>
      <g>
...
export function MoreVerticalIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 21 20" strokeWidth="2" {...properties}>
...
export function ExternalLinkIcon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 17 17" fill="currentColor" {...properties}>
      <path d="M14.1667 7.79167C13.9788 7.79167 13.7986 7.86629 13.6658 7.99913C13.533 8.13197 13.4583 8.31214 13.4583 8.5V12.75C13.4583 12.9379 13.3837 13.118 13.2509 13.2509C13.118 13.3837 12.9379 13.4583 12.75 13.4583H4.25C4.06214 13.4583 3.88197 13.3837 3.74913 13.2509C3.61629 13.118 3.54167 12.9379 3.54167 12.75V4.25C3.54167 4.06214 3.61629 3.88197 3.74913 3.74913C3.88197 3.61629 4.06214 3.54167 4.25 3.54167H8.5C8.68786 3.54167 8.86803 3.46704 9.00087 3.3342C9.13371 3.20136 9.20833 3.02119 9.20833 2.83333C9.20833 2.64547 9.13371 2.4653 9.00087 2.33247C8.86803 2.19963 8.68786 2.125 8.5 2.125H4.25C3.68641 2.125 3.14591 2.34888 2.7474 2.7474C2.34888 3.14591 2.125 3.68641 2.125 4.25V12.75C2.125 13.3136 2.34888 13.8541 2.7474 14.2526C3.14591 14.6511 3.68641 14.875 4.25 14.875H12.75C13.3136 14.875 13.8541 14.6511 14.2526 14.2526C14.6511 13.8541 14.875 13.3136 14.875 12.75V8.5C14.875 8.31214 14.8004 8.13197 14.6675 7.99913C14.5347 7.86629 14.3545 7.79167 14.1667 7.79167Z" />
      <path d="M11.3334 3.54167H12.4525L7.99712 7.99C7.93073 8.05585 7.87803 8.13419 7.84207 8.22051C7.80611 8.30682 7.7876 8.39941 7.7876 8.49292C7.7876 8.58642 7.80611 8.67901 7.84207 8.76533C7.87803 8.85164 7.93073 8.92998 7.99712 8.99583C8.06297 9.06222 8.14131 9.11492 8.22763 9.15088C8.31395 9.18684 8.40653 9.20536 8.50004 9.20536C8.59355 9.20536 8.68613 9.18684 8.77245 9.15088C8.85876 9.11492 8.93711 9.06222 9.00295 8.99583L13.4584 4.5475V5.66667C13.4584 5.85453 13.533 6.0347 13.6658 6.16753C13.7987 6.30037 13.9788 6.375 14.1667 6.375C14.3546 6.375 14.5347 6.30037 14.6676 6.16753C14.8004 6.0347 14.875 5.85453 14.875 5.66667V2.83333C14.875 2.64547 14.8004 2.4653 14.6676 2.33247C14.5347 2.19963 14.3546 2.125 14.1667 2.125H11.3334C11.1455 2.125 10.9653 2.19963 10.8325 2.33247C10.6997 2.4653 10.625 2.64547 10.625 2.83333C10.625 3.02119 10.6997 3.20136 10.8325 3.3342C10.9653 3.46704 11.1455 3.54167 11.3334 3.54167Z" />
    </SvgIcons>
  )
}

export function Rotate360Icon(properties: SvgIconProperties) {
  return (
    <SvgIcons viewBox="0 0 24 25" fill="currentColor" {...properties}>
